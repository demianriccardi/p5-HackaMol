...
my $obj = Class_with_PhysVecRole->new( name => 'foo', t => 0 , charges => [0.1], coords => [[0,1,2]]); 
...
would be Num that is rw and lazy with a default of (build from t-dependent charges) or 0
...
have been cleared before calling on charge.  Being 'rw' charge could be set to whatever,
whenever without effect on the charges array. I haven't decided on adding this yet. Send
your thoughts.
