...
VERSION
========
developer version 0.00_08 
Available for testing from cpan.org:
       
please see *[HackaMol on MetaCPAN](https://metacpan.org/release/DEMIAN/HackaMol-0.00_08) for formatted documentation.  
...
once it is officially released. For now, you can install the developer release. Again with cpanminus:
       ...
       cpanm DEMIAN/HackaMol-0.00_08.tar.gz
